...
- Each autonomous cycle receives persistent operator benchmarks and a direction-aware comparison with the prior cycle. The campaign currently proves 99 routes, 44 live read-only capabilities, and 55 no-side-effect mutation preflights.
