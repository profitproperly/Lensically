...
function buildGeneratePrompt(context, rejectionLessons, rejectionPolicy, approvalLessons, guidance, tasteMemory, savedPatternMemory, generationSlots, existingPosts = [], extraConstraints = []) {
  ...
  return [
    ...
    "Before generating posts, read the taste memory first.",
    "All-time winners from this account are the primary evidence pool. Start from what has already won hardest on this account.",
    "Do not let saved patterns steer the slate. They are background material at most, not the source of truth.",
    ...
    "Read the all-time champions first. Use recent winners, approval lessons, and fatigue summary only as supporting context.",
    ...
    "Default to the proven opener families first: 'You're about to ...', 'The person reading this ...', and the exact opener 'To the person reading this ...'.",
    "Treat 'The person reading this is about to ...' as a primary winning opener, not a backup variation.",
    "Treat the exact opener 'To the person reading this ...' as a primary winning opener family. Do not shorten it to 'To the person reading'.",
    ...
    "Rejection policy is the hardest law. All-time winners and approval lessons are the main positive steering.",
    "If an all-time winner from this account already proves a sentence shape works, prefer that account-native winner shape over everything else.",
