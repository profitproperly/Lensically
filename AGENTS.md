...
- Local Codex sessions read `AGENTS.md`, `OPERATING_MEMORY.md`, and `CURRENT_STATE.md` before Lensically work. ChatGPT Operator MCP sessions instead assume zero retained Lensically knowledge and must complete the structured `getOperatorStartupContext` session competency boot before the first non-startup action; do not make ChatGPT rediscover the shop during work.
