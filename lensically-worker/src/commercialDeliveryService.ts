...
export const COMMERCIAL_PRODUCT_PRICE_ID = "price_1U3Hro4dwsz5Id6rKaAguF1o";
export const COMMERCIAL_PAYMENT_LINK_ID = "plink_1U3Hs24dwsz5Id6ryF7lLlTs";
export const COMMERCIAL_EMBEDDED_CHECKOUT_MARKER = "embedded_checkout_v1";
export const COMMERCIAL_PRODUCT_AMOUNT = 9_700;
