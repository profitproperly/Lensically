...
const OPERATOR_MCP_TOOLS: OperatorMcpToolDefinition[] = [
  ...
  },
  {
    ...
    title: "Create generation run",
        description: "Create one new adaptation from a locked canonical source-card version. The tool returns prior uses/results and stores a structured adaptation plan so repeated source use is deliberate rather than repetitive. After source-card approval, this is a silent internal operation: do not ask the owner to approve or proceed after this tool; continue through candidate generation and gate evaluation until a showable draft is ready.",
