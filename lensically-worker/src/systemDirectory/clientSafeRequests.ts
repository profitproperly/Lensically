...
export const PREVENTED_CLIENT_BLOCKS: readonly PreventedClientBlock[] = [
  ...
  { id: "public_repeated_validation_dispatch", observed_on: "2026-07-19", status: "live", blocked_shape: "A Recovery validation request contained only task=operator-tests.", cause: "OpenAI client preflight rejected the previously accepted task-only validation dispatch before Recovery received it.", safe_profile_id: "repository_patch_set", regression_test_id: "uses Main push markers after validation dispatch is client-blocked", source_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, ".github/workflows/lensically-engineering.yml", "lensically-worker/scripts/release-preflight.mjs"] },
