...
export const PREVENTED_CLIENT_BLOCKS: readonly PreventedClientBlock[] = [
  ...
  { id: "recovery_exact_sha_validation_dispatch", observed_on: "2026-07-18", status: "live", blocked_shape: "A Recovery diagnostic-test dispatch included an exact 40-character repository SHA.", cause: "OpenAI client preflight rejected the exact-SHA validation request before Recovery received it.", safe_profile_id: "validation_dispatch", regression_test_id: "uses task-only validation dispatches and reserves exact SHA for deployment", source_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, "lensically-worker/test/systemDirectory.spec.ts"] },
