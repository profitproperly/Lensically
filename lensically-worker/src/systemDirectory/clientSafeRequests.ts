...
export const PREVENTED_CLIENT_BLOCKS: readonly PreventedClientBlock[] = [
  ...
  { id: "public_large_repository_mutation_payload", observed_on: "2026-07-18", status: "live", blocked_shape: "A public implementation request carried a large universal repository-mutation specification in one payload.", cause: "OpenAI client preflight rejected the implementation request before Lensically received it.", safe_profile_id: "recovery_repository_mutation", regression_test_id: "routes large repository mutations to the promoted Recovery path", source_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, "lensically-worker/src/mandatoryExecutionMap.ts", "lensically-worker/test/systemDirectory.spec.ts"] },
