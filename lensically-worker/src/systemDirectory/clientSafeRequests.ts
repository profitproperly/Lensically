...
export const CLIENT_SAFE_REQUEST_PROFILES: Readonly<Record<ClientSafeRequestProfileId, ClientSafeRequestProfile>> = {
  ...
  validation_dispatch: { id: "validation_dispatch", objective: "Dispatch one branch-head validation task through the independent control surface.", intent: "recovery validation dispatch", allowed_input_keys: ["task"], max_input_characters: 80, surface: "recovery_plane" },
