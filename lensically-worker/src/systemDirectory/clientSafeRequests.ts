...
export const CLIENT_SAFETY_POLICIES: readonly ClientSafetyPolicy[] = [
  ...
  { id: "typed_account_keys_only", summary: "Account identifiers and compact aliases may appear only in typed brand_key fields, never enumerated in free-text public searches.", enforcement_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, "lensically-worker/src/index.ts"] },
    { id: "no_identical_blocked_retry", summary: "Allow one workflow-status read per chat. Every later workflow check uses the Main workflow_run_list compact activity profile, including checks for another run ID.", enforcement_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, "lensically-worker/src/index.ts"] },
...
export const PREVENTED_CLIENT_BLOCKS: readonly PreventedClientBlock[] = [
  ...
  { id: "recovery_release_marker_verbose_message", observed_on: "2026-07-18", status: "live", blocked_shape: "A verified release-marker exact patch used a descriptive semantic commit message.", cause: "OpenAI client preflight rejected the patch before Recovery received it; the same exact replacement with a compact marker message succeeded.", safe_profile_id: "verified_release_marker", regression_test_id: "uses compact release-marker messages for verified patches", source_locations: [CLIENT_SAFETY_CANONICAL_LOCATION, "lensically-worker/test/systemDirectory.spec.ts", ".github/workflows/lensically-engineering.yml"] },
