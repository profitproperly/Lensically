...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    plane: "publishing",
    system_of_record: "scheduled post deletion ledger, linked drafts, and autonomous lineup items",
    primary_surfaces: ["Scheduled Posts", "Deleted post history", "autonomous cycle context"],
    objects: ["scheduled post deletion", "deletion reason", "cleared slot", "deleted-post evidence"],
    keywords: ["delete scheduled post", "why was this post deleted", "deleted post history", "clear scheduled slot"],
    capabilities: ["delete one approved unpublished post", "require and preserve a deletion reason", "expose deletion evidence to owner and model"],
    ...
    related_entry_ids: ["publishing.scheduled_posts", "content.manifest_scheduled_review", "strategy.manifest_autonomous_cycle"],
    recommended_next_planes: ["publishing", "content_production", "analytics"],
    hard_gates: ["A nonempty reason is mandatory.", "Only approved unpublished posts may be deleted.", "Original text, slot, actor, source, timestamp, and reason remain durable.", "Deletion does not write strategy memory automatically."],
  },
  {
