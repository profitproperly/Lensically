...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    plane: "deployment",
        system_of_record: "Main validation workflow, verified source marker, and Cloudflare Worker versions",
    primary_surfaces: ["Lensically Validation workflow", "Cloudflare Worker deployment"],
    objects: ["deployment", "Worker version", "release", "live commit"],
    keywords: ["deploy", "release", "ship", "live worker", "exact SHA"],
    capabilities: ["verify repository head", "commit Main release marker", "verify live version"],
    ...
    recommended_next_planes: ["engineering"],
    hard_gates: ["Main release markers require a verified repository head and passing validation.", "Recovery remains break-glass only."],
  },
  {
