...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    related_entry_ids: ["analytics.performance_learning", "analytics.content_focus", "content.manifest_autonomous_runway", "publishing.scheduled_posts"],
    recommended_next_planes: ["content_production", "publishing"],
  ...
  {
    id: "content.manifest_autonomous_runway",
    title: "Manifest autonomous runway commit",
    plane: "content_production",
    system_of_record: "autonomous cycle lineup, source-card families, generation runs, drafts, gates, scheduled posts, strategy tags, and inventory",
    primary_surfaces: ["autonomous lineup", "scheduled runway", "source-to-metrics lineage"],
    objects: ["autonomous post", "lineup assignment", "missing schedule slot", "operator hypothesis"],
    keywords: ["commit autonomous runway", "schedule missing 48 hours", "fill rolling schedule", "autonomous generation"],
    capabilities: ["schedule up to 24 exact missing slots", "preserve full post lineage", "self-reject gate failures", "resume an incomplete cycle idempotently"],
    payload: { action_size: "bounded_mutation", max_results: 24, max_response_bytes: 24000, required_inputs: ["brand_key", "cycle_id", "strategic_thesis", "posts"] },
    route_intent: "commit manifest autonomous runway",
    ...
    hard_gates: ["Only exact missing slots from the prepared cycle may be committed.", "Every post must pass generation and scheduling gates.", "Every accepted post requires complete lineage."],
  },
  {
    ...
    related_entry_ids: ["content.manifest_autonomous_runway", "publishing.scheduled_posts", "content.production"],
    recommended_next_planes: ["content_production", "publishing"],
