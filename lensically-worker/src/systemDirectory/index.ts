...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    objects: ["brand key", "selected account", "workflow continuity", "account profile"],
    keywords: ["manifest mental", "vectrix", "opmg", "proceed", "resume workflow"],
    capabilities: ["select account", "confirm Proceed", "restore canonical continuity"],
