...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    plane: "engineering",
        system_of_record: "Live D1 PRAGMA state reconciled with versioned repository migrations",
    primary_surfaces: ["D1 tables", "columns", "indexes", "versioned migrations", "trigger behavior tests"],
