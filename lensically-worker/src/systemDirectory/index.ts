...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    plane: "engineering",
    system_of_record: "Live D1 sqlite_master reconciled with versioned repository migrations",
    primary_surfaces: ["D1 tables", "indexes", "triggers", "views", "versioned migrations"],
