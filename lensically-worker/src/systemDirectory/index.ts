...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    primary_surfaces: ["one-to-four candidate batch", "item-level persistence results", "selective regeneration", "single batch coverage receipt"],
    objects: ["bounded candidate batch", "accepted sibling", "rejected slot", "batch reconciliation"],
    keywords: ["persist manifest autonomous batch", "persist four posts", "selective regeneration", "reconcile batch coverage"],
    capabilities: ["persist one to four exact plan items", "preserve successful siblings", "return exact rejected slots and reasons", "retain item-level gates and lineage", "reconcile coverage exactly once"],
    payload: { action_size: "bounded_mutation", max_results: 4, max_response_bytes: 24000, required_inputs: ["brand_key", "cycle_id", "cycle_strategy_id", "batch_operation_id", "candidates"] },
