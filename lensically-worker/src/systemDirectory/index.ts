...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
    ...
    objects: ["operator session map", "lifecycle map", "fresh session bootstrap", "recursive knowledge tree"],
    keywords: ["startup", "session map", "bootstrap", "lifecycle", "fresh session"],
  ...
  },
  {
    ...
    payload: { action_size: "bounded_mutation", max_response_bytes: 24000, required_inputs: ["live_state_token", "profile_id", "inputs"] },
