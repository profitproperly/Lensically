...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    primary_surfaces: ["autonomous cycle", "rolling 28-day evidence", "48-hour runway", "analysis page manifest"],
    objects: ["autonomous growth cycle", "evidence snapshot", "rolling runway", "missing hourly slots"],
    keywords: ["prepare autonomous cycle", "build rolling evidence", "reconcile 48 hours", "analyze last 28 days"],
    capabilities: ["reconcile live account position", "capture complete likes-first evidence", "return canonical analysis pages", "preserve exact runway coverage"],
    ...
    related_entry_ids: ["strategy.manifest_cycle_analysis_page", "strategy.manifest_cycle_strategy", "content.manifest_autonomous_post_persistence", "publishing.scheduled_posts"],
    recommended_next_planes: ["content_production", "publishing"],
    hard_gates: ["Existing scheduled posts are preserved.", "Every required evidence page must be consumed before strategy lock.", "The primary performance metric is 24-hour likes.", "No post may be generated during preparation."],
  },
  {
    id: "strategy.manifest_cycle_analysis_page",
    title: "Manifest rolling evidence page",
    plane: "content_production",
    system_of_record: "operator_manifest_evidence_snapshots, operator_manifest_evidence_pages, and durable analysis-consumption records",
    primary_surfaces: ["cycle evidence", "analysis page", "28-day post history", "maturity evidence"],
    ...
    recommended_next_planes: ["content_production"],
    hard_gates: ["The requested page must belong to the cycle snapshot.", "Post evidence must not be silently truncated.", "All required pages must be consumed before strategy lock."],
  },
  {
    ...
    related_entry_ids: ["strategy.manifest_cycle_analysis_page", "content.manifest_autonomous_post_persistence", "content.manifest_autonomous_batch_persistence", "content.sources"],
    recommended_next_planes: ["content_production"],
