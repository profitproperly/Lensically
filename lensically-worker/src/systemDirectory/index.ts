...
export const LENSICALLY_SYSTEM_DIRECTORY_ENTRIES: readonly SystemDirectoryEntry[] = [
  ...
  },
  {
    ...
    capabilities: ["load task-relevant durable knowledge", "prove exact loaded node versions", "keep knowledge out of startup routing layers"],
            payload: { action_size: "bounded_read", max_response_bytes: 24000, required_inputs: ["session_map_token", "node_ids"] },
  ...
  },
  {
    ...
    capabilities: ["load current mutable truth", "aggregate only requested live-state scopes", "issue Step-3 execution proof"],
            payload: { action_size: "bounded_read", max_response_bytes: 24000, required_inputs: ["knowledge_token", "scopes"] },
