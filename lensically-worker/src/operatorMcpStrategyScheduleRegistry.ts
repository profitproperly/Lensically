  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        owner_note: { type: "string", description: "The owner's full note, preserved verbatim with this exact revision and its linked source-card evidence." },
        editor_type: { type: "string", enum: ["model", "owner"], description: "Truthful authorship of the revised text. Use owner only when the owner supplied or directly dictated the final wording." },
