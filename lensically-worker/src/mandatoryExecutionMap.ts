...
export const WINNING_PATH_PROMOTIONS: readonly WinningPathPromotion[] = [
  ...
  },
  {
    ...
    scope: "universal",
    binding_scope: "runtime_guard",
    enforcement_point: "recordHardeningIncident closed-family recurrence classification after causal-family normalization and before prevention-regression incident creation.",
    regression_test_id: "converges handled OpenAI provider recurrences without reopening hardening while preserving true prevention regressions",
    supersession_rule: "Any replacement must preserve every provider occurrence as durable evidence, keep blocked actions non-received and non-replayed by default, avoid reopening hardening solely for recurrence of the externally controlled event once the handling prevention is proven, and retain blocking prevention-regression semantics for genuine controllable prevention escapes.",
  },
  {
