...
export const WINNING_PATH_PROMOTIONS: readonly WinningPathPromotion[] = [
  ...
  },
  {
    ...
    scope: "universal",
    binding_scope: "runtime_guard",
        enforcement_point: "recordHardeningIncident causal-family normalization, route-scoped active recurrence selection, family-wide closed-provider convergence before prevention-regression incident creation, and getHardeningStatus historical provider-debt reconciliation across legacy non-receipt shapes.",
