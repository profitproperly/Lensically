        ...
        wrangler: { configPath: "./wrangler.jsonc" },
          ...
          bindings: { TEST_MIGRATIONS: migrations },
            ...
            UPGRADE_DB: { id: "lensically-upgrade-test" },
                        ...
                        PERFORMANCE_FOCUS_UPGRADE_DB: { id: "lensically-performance-focus-upgrade-test" },
                        MANIFEST_INTELLIGENCE_UPGRADE_DB: { id: "lensically-manifest-intelligence-upgrade-test" },
                        MANIFEST_ENGINE_UPGRADE_DB: { id: "lensically-manifest-engine-upgrade-test" },
                        MANIFEST_MEASUREMENT_AUDIT_UPGRADE_DB: { id: "lensically-manifest-measurement-audit-upgrade-test" },
            FINAL_AUTHORITY_UPGRADE_DB: { id: "lensically-final-authority-upgrade-test" },
          },
        },
