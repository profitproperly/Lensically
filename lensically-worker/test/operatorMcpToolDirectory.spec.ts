...
describe("Operator MCP tool directory", () => {
                                                                it("preserves the nine-tool, five-stage public lifecycle surface while keeping capabilities internal", () => {
    expect(OPERATOR_PUBLIC_DIRECT_TOOL_NAMES.size).toBe(9);
