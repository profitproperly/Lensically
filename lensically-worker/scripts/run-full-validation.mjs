...
const COMPLETE_TEST_FILE_PARALLELISM = false;
...
const completeTestFiles = [
  ...
  "test/operatorGithubMutationRetry.spec.ts",
  "test/operatorHourlyCoverageService.spec.ts",
    "test/operatorManifestPrepareCheckpointService.spec.ts",
    "test/operatorManifestDecisionBundleService.spec.ts",
  "test/operatorManifestBatchPersistenceService.spec.ts",
  ...
  "test/sourceFamilySelection.spec.ts",
...
function validatePlan() {
  ...
  if (COMPLETE_TEST_FILE_PARALLELISM !== false) {
    fail("full_validation_file_parallelism_guard_invalid");
  }
  ...
  return {
    ...
    complete_test_file_parallelism: COMPLETE_TEST_FILE_PARALLELISM,
  };
}
