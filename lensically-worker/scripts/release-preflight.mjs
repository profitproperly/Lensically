...
// Fresh-chat acceptance requires startup documents, runtime profiles, Main validation routes, and deployment policy to match the advertised profile-only action schema.
