...
if (!source.includes('const OPERATOR_GROWTH_MISSION_VERSION = "autonomous-growth-mission-v2"')
    ...
    || !source.includes('no_internal_gate_fanout: true')
    || !source.includes('no_internal_runway_scan: true')
    ...
    || !source.includes('required: ["generation_passed", "scheduling_passed", "novelty_assessment", "winner_preservation_assessment", "slot_placement_assessment", "recent_exposure_assessment"]')
