...
replaceRange("async function ensureAgentAccountControlsTable(env: Env): Promise<void> {", "async function bootstrapConfiguredThreadsAccounts(env: Env): Promise<void> {", "", "Agent account-control implementation");
replaceRange("async function buildOperatorRejectionContextLegacyUnused(env: Env, brand: GptResolvedBrand): Promise<Record<string, unknown>> {", "async function insertOperatorInventory(", "", "legacy owner-rejection learning implementation");
...
replaceRange("async function ensureAutomationDailyRunLocksTable(env: Env): Promise<void> {", "async function upsertThreadsPostsArchive(", "", "legacy automation daily-run implementation");
