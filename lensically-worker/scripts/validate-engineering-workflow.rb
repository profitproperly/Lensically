...
push_acceptance_test_run = step_run(jobs, "push-validation", "Test release acceptance contract")
abort("push_release_acceptance_test_missing") unless push_acceptance_test_run.include?("node scripts/test-release-acceptance.mjs")
push_acceptance_validate_run = step_run(jobs, "push-validation", "Validate release acceptance contract")
abort("push_release_acceptance_validation_missing") unless push_acceptance_validate_run.include?("node scripts/validate-release-acceptance.mjs")
