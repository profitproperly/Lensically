...
const TOOLS: Tool[] = [
  ...
  { name: "runMainMcpSmoke", title: "Run main MCP smoke", description: "Run the live main-MCP OAuth, initialize, one-tool discovery, server-side startup, direct-call rejection, and mandatory execution-map path. Returns compact startup client-safety, System Directory, and tool-surface receipts.", inputSchema: { type: "object", properties: {}, additionalProperties: false }, annotations: { readOnlyHint: true, openWorldHint: true } },
];
