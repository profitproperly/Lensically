...
const TOOLS: Tool[] = [
  ...
  { name: "runMainMcpSmoke", title: "Run main MCP smoke", description: "Run the live main-MCP OAuth, initialize, two-tool discovery, startup, direct-call rejection, and routed-gateway execution path.", inputSchema: { type: "object", properties: {}, additionalProperties: false }, annotations: { readOnlyHint: true, openWorldHint: true } },
];
