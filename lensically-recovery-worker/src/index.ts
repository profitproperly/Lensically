...
const TOOLS: Tool[] = [
  ...
  { name: "runMainMcpSmoke", title: "Run main MCP smoke", description: "Run live Main OAuth, initialization, deployment-scoped session enforcement, the 84-tool direct public contract, direct startup and read paths, the capability campaign, and scheduler health.", inputSchema: { type: "object", properties: {}, additionalProperties: false }, annotations: { readOnlyHint: true, openWorldHint: true } },
];
