...
// Recovery source commits may carry [operator-tests] to trigger one bounded current-head validation proving canonical policies survive initial and forced refresh.
