...
// Recovery source commits may carry [operator-tests] to trigger one bounded current-head main-worker validation after all source and policy guards are complete.
