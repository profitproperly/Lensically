...
// Recovery source commits may carry [operator-tests] to trigger one bounded validation of health metadata generation, single-preparation routing, compact receipts, and canonical execution policy enforcement.
