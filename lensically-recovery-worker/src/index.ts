...
// Recovery source commits may carry [operator-tests] to trigger one bounded validation of isolated execution-source refresh and canonical policy enforcement.
