...
// Recovery source commits may carry [operator-tests] to trigger one bounded validation of prepared tables, seeded startup, and canonical execution policy enforcement.
